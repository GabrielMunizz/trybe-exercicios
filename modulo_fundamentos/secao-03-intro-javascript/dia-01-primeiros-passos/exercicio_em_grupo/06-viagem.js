...
let spBHEmMinutos = (7 * 60) + 23;
let bhSalvadorEmMinutos = (19 * 60) + 57;
let salvadorNatalEmMinutos = (15 * 60) + 32;
let spNatalEmMinutos = spBHEmMinutos + bhSalvadorEmMinutos + salvadorNatalEmMinutos;
let minutosEmUmDia = 1440;
let tempoViagemEmHoras = spNatalEmMinutos/minutosEmUmDia
console.log(tempoViagemEmHoras.toFixed(3))